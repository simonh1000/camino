...
// }
// */
// console.log("** firebase-messaging-sw 1.2.3 **");
// messaging.onBackgroundMessage((payload) => {
//     console.log("[firebase-messaging-sw.onBackgroundMessage] " + self.location.href, payload);
//     // Customize notification here
//     const notificationTitle = payload.data.rmx_title || payload.notification.title;

//     const notificationOptions = {
//         body: payload.data.rmx_body || payload.notification.body,
//         icon: payload.data.rmx_icon || "https://remixlabs.com/images/remix-glyph.png",
//         // and copy everything just to be certain
//         data: payload.data || {},
//     };

//     if (payload.data.rmx_payload) {
//         // put into indexdb
//         const rmx_payload = JSON.parse(payload.data.rmx_payload);
//         console.warn("Implement persistence of rmx_payload", rmx_payload);
//     }

//     // console.log("[firebase-messaging-sw.onBackgroundMessage]", { notificationTitle, notificationOptions });
//     self.registration
//         .showNotification(notificationTitle, notificationOptions)
//         // .then(() => console.log("[firebase-messaging-sw.showNotification] confirmed"))
//         .catch((err) => console.error("[firebase-messaging-sw.showNotification]", err));
// });
